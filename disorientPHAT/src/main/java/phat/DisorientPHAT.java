 ...
 * @author melkoroth
 */
public class DisorientPHAT implements PHATInitializer, PHATCommandListener, SensorListener {
    static GUIPHATInterface phat;

    private static String fileName = "disorient.txt";
    ...
    public static void main(String[] args) throws IOException {
        //String[] a = {"-record"};
        DisorientPHAT sim = new DisorientPHAT();
    ...
    public String getTittle() {
        return "PHAT Presence Disorient Experiment";
    }

    @Override
    public String getDescription() {
        return "This is a proof of concept simulation where the patient does disorient";
    }
